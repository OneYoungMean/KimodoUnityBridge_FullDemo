namespace KimodoUnityBridge.Command
{
    ...
    public static class command_session
    {
        ...
        public const string GetRawCommand = command_context.SessionGetRawCommand;
        ...
        public static string GetRaw(string argumentsJson) => command_dispatcher.Invoke(GetRawCommand, argumentsJson);
